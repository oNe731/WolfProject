...
public class SlimeBoss_Phase3 : SlimeBoss_Base
{
    private SlimeBoss_Berserk m_berserk;
    private float m_stateTime = 0f;

    public SlimeBoss_Phase3(StateMachine<Monster> stateMachine, SlimeBoss_Berserk berserkState) : base(stateMachine)
    {
